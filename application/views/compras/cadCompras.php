...
<?php
echo link_ng('compras/controllers/cadComprasController.js');
?>
<div ng-controller="cadComprasController" ng-cloak>
    ...
    <form novalidate name="form_compras" id="form_compras">
            ...
            <div class="row">
                <div class="col-sm-5">
                    <div class="form-group">
                        ...
                        <input ng-model="itensCompras.id_produto"  ng-class="form_compras.id_produto.$dirty && form_compras.id_produto.$invalid?'form-group-error':''" select2 urlajax="../produtos/getProdutosFiltro" type="hidden" name="id_produto" id="id_produto" ng-required="true">
                    </div>
                </div>
                <div class="col-sm-2">
                    <div class="form-group">
                        <label for="qtde">*Qtde.:</label>
                         <input  ng-class="form_compras.qtde.$dirty && form_compras.qtde.$invalid?'form-group-error':''" type="text" name="qtde" id="qtde" maxlength="20" class="form-control" ng-required="true" ng-model="itensCompras.qtde" ui-number-mask="0">
        ...
        <div class="pull-right">
            ...
            <button type="button" class="btn btn-success" ng-click="submitCompras()">Salvar compra</button>
        </div>
    </form>
</div>
